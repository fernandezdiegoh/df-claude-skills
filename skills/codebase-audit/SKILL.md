...
Search for a previous audit report in the project (e.g., `docs/codebase-audit-*.md`, `docs/audit-*.md`, `AUDIT.md`). If found:
...
---
*Generated by codebase-audit v3.1.0*
EOF
)" \
...
Date: [date]
Auditor: Claude (codebase-audit v3.1.0)
