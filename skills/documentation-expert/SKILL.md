...
| **ADR** | Architecture Decision Record — why a choice was made | Future team members | `docs/adr/001-<title>.md` |
...
|-----|------|--------|-------------|-------|
| README.md | readme | ✅ current | 2026-02-10 | Good quickstart, missing API section |
| docs/architecture.md | architecture | ⚠️ stale | 2025-11-03 | References old module structure |
| docs/api.md | api-reference | ❌ missing | — | No API docs exist |
...
1. **Lead with the action.** Don't start with background — start with what someone needs to do. Background goes in a "Context" section after the actionable content.
...
## What it does
2-3 sentences. Not the tech stack — the problem it solves.
